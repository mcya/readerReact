...
class BookIntroduce extends React.Component{
  ...
  componentWillReceiveProps(nextProps) {
    ...
    this.share = `我在基于React的移动阅读APP看《${this.data.title}》，绿色无广告，你也一起来呗！地址是${window.location.href}，移动端请手动复制这条信息。`;
  ...
  render() {
    console.log('详情页数据this.data', this.data);
    return (
      <div>
        <Layout >
                ...
                (
                  <div>
                    ...
                    <div className={styles.control}>
                      ...
                      <Button icon='play-circle-o' size='large' onClick={this.beiginRead}>开始阅读</Button>
                    </div>
                    <div className={styles.number}>
                      <p><span>正在看人数</span><br/>{this.data.latelyFollower}</p>
                      <p><span>读者收藏率</span><br/>{this.data.retentionRatio}%</p>
